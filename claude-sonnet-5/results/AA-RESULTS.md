...
The heavier-task figures to quote are the pooled ones: sums 8.8% higher, mean paired cost 9.7% lower, 13 of 27 pairs, 26 of 27 TokenSaver trials and 25 of 27 plain trials correct. The next cohorts measure each TokenSaver component alone against plain on pulldown-cmark and textwrap, and a repository summary that maps the definitions of the large crate the agent must navigate.
